...
const filterTabs = ["Bonos", "Métodos", "Juegos", "En vivo", "Casinos nuevos"] as const;
...
export default function CountryPage() {
  ...
  return (
    <>
      {/* Hero */}
      <section className="relative flex min-h-[50vh] items-end overflow-hidden bg-dark-surface" aria-label="Hero país">
        ...
        <div className="relative z-10 container pb-10 pt-24">
          <h1 className="max-w-lg font-heading text-3xl font-black leading-tight text-dark-surface-foreground md:text-4xl">
          ...
          <p className="mt-3 max-w-md text-sm text-dark-surface-foreground/80 md:text-base">
            Compara los mejores sitios de casinos en {country.name} y disfruta de bonos exclusivos, giros gratis y
            juegos populares de forma segura y legal {country.flag}
          </p>
        </div>
      </section>
      ...
      <section className="bg-muted py-10">
        <div className="container">
          ...
          <div className="mt-6 grid gap-4">
            {apuestas.map((c) => (
              <CasinoCard key={c.rank} casino={{ ...c, rank: c.rank }} countryFlag={country.flag} />
            ))}
          </div>
        </div>
      </section>
